...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    <div className="w-64 lg:w-20 hover:lg:w-64 group/sidebar bg-gray-800 border-r border-gray-700 h-screen sticky top-0 flex flex-col transition-all duration-300 overflow-hidden z-50">
      <div className="h-20 px-4 lg:px-5 flex items-center justify-between border-b border-gray-700 shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col whitespace-nowrap overflow-hidden transition-all duration-300 lg:max-w-0 lg:opacity-0 group-hover/sidebar:lg:max-w-[200px] group-hover/sidebar:lg:opacity-100">
            <h1 className="text-lg font-bold text-white bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent leading-tight">
              Smart Egg
            </h1>
      ...
      <nav className="flex-1 py-6 px-3 flex flex-col gap-2 overflow-y-auto">
        ...
        <div className="mt-auto pt-4 border-t border-gray-700 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center lg:justify-start justify-center gap-3 px-3 lg:px-4 py-3 bg-red-600/20 hover:bg-red-600/40 text-red-500 rounded-xl transition-colors group"
            title="Logout"
          >
