  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-4 lg:mb-8">
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm border border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-white">ESP32 DevKit v1</h3>
            {isConnected ? (
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white">{isConnected ? data?.signalStrength || 0 : 0}%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-4 lg:mb-8">
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm border border-gray-700">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
            <h3 className="font-semibold text-white">Temperature Chart</h3>
            <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-400">
              <span>
                Min: <strong className="text-white">{tempStats.min}</strong>
              </span>
              <span>
                Max: <strong className="text-white">{tempStats.max}</strong>
              </span>
              <span>
                Avg: <strong className="text-white">{tempStats.avg}</strong>
              </span>
            </div>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm border border-gray-700">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
            <h3 className="font-semibold text-white">Humidity Chart</h3>
            <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-400">
              <span>
                Min: <strong className="text-white">{humStats.min}</strong>
              </span>
              <span>
                Max: <strong className="text-white">{humStats.max}</strong>
              </span>
              <span>
                Avg: <strong className="text-white">{humStats.avg}</strong>
              </span>
            </div>
          </div>
          <div className="h-64 w-full relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-4 lg:mb-8">
        {/* Device Control */}
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm border border-gray-700">
          <h3 className="font-semibold text-white mb-4">Device Control</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-900/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-sm text-white">Camera Flash</span>
              </div>
              <button
                onClick={toggleFlash}
            ...
            <div className="flex items-center justify-between p-3 bg-gray-900/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-sm text-white">Heater (Auto)</span>
              </div>
              <button
        ...
        {/* Motor Configuration */}
        <div className="bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm border border-gray-700">
          <h3 className="font-semibold text-white mb-4">Motor Configuration</h3>
